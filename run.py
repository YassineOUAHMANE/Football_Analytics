...
parser.add_argument(
    "--video",
    default="videos/FC Barcelona VS REAL MADRID.mp4",
    type=str,
...
Real_madrid = Team(name="Real Madrid", abbreviation="RMA", color=(240, 230, 188))
teams = [FCB, Real_madrid]
match = Match(home=FCB, away=Real_madrid, fps=fps)
match.team_possession = Real_madrid
